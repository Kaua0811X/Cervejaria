...
const appCss = "/Cervejaria/assets/styles-UncG81r_.css";
function RouteTransition() {
  const location = useLocation();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "route-transition", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }, location.pathname);
}
...
const Route$6 = createFileRoute("/sobre")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "A história da Rei do Malte: uma cervejaria nascida em 2026 que une tradição artesanal e automação inteligente."
    }]
  })
});
...
const Route$5 = createFileRoute("/sensor")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Monitoramento IoT em tempo real da produção."
    }]
  })
});
...
const Route$4 = createFileRoute("/receita")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Receita Session Pilsen SQN — 5 litros. Processo técnico completo da Rei do Malte."
    }]
  })
});
...
const Route$3 = createFileRoute("/loja")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Vitrine de cervejas artesanais premium: IPA, Pilsen, Weiss e Stout."
    }]
  })
});
...
const Route$2 = createFileRoute("/documentos")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Acesse aqui todos os documentos e links principais da marca."
    }]
  })
});
...
const Route$1 = createFileRoute("/dashboard")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Monitoramento térmico em tempo real do lote Session Pilsen SQN — da mostura à carbonatação."
    }]
  })
});
...
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Cervejaria artesanal premium. Maltes selecionados, tecnologia e tradição medieval."
    }]
  })
});
...
const SensorRoute = Route$5.update({
  id: "/sensor",
  path: "/sensor",
  getParentRoute: () => Route$7
});
const ReceitaRoute = Route$4.update({
  id: "/receita",
  path: "/receita",
  getParentRoute: () => Route$7
});
const LojaRoute = Route$3.update({
  id: "/loja",
  path: "/loja",
  getParentRoute: () => Route$7
});
const DocumentosRoute = Route$2.update({
  id: "/documentos",
  path: "/documentos",
  getParentRoute: () => Route$7
});
