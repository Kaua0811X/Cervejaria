...
import "node:stream";
const heroBg = "/Cervejaria/assets/hero-bg-UrRxatxi.jpg";
function Index() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-screen flex items-center justify-center overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 mx-auto max-w-5xl px-6 text-center py-32", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block text-[11px] uppercase tracking-[0.5em] text-gold mb-6 px-4 py-1.5 rounded-full border border-gold-soft glass", children: "⚜ desde 2026 ⚜" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-20 flex flex-wrap gap-4 justify-center max-w-3xl mx-auto", children: [{
          v: "5",
          l: "Litros / mês"
        }, {
          v: "1",
