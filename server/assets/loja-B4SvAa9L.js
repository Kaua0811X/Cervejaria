...
const umLitro = "/Cervejaria/assets/1litro-J1Jz4xFM.jpeg";
const seiscentosMl = "/Cervejaria/assets/600ml-CrnbC6Nn.jpeg";
const duzentosSessentaNoveMl = "/Cervejaria/assets/269ml-CZuRZdGx.jpeg";
const beers = [{
  size: "1 litro",
  price: "R$ 29,90",
  image: umLitro,
...
function Loja() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PageShell, { title: "Nossa Loja", kicker: "", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 pb-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center max-w-2xl mx-auto text-[color:var(--muted-foreground)] mb-14" }),
