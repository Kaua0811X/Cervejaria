import { e as commonjsGlobal, x as getDefaultExportFromCjs, T as reactExports, R as React } from "./server-DCdKjH6Y.js";
function r(e) {
  var t, f, n = "";
...
var _excluded$e = ["children"], _excluded2$3 = ["children"];
...
var hasClipDot = function hasClipDot2(dot) {
  return dot && _typeof$B(dot) === "object" && "clipDot" in dot;
};
...
var isSingleChildEqual = function isSingleChildEqual2(nextChild, prevChild) {
  ...
  if (!isNil(nextChild) && !isNil(prevChild)) {
    ...
    var _ref2 = prevChild.props || {}, prevChildren = _ref2.children, prevProps = _objectWithoutProperties$e(_ref2, _excluded2$3);
    if (nextChildren && prevChildren) {
...
function Surface(props) {
  ...
  return /* @__PURE__ */ React.createElement("svg", _extends$l({}, filterProps(others, true, "svg"), {
...
var Layer = /* @__PURE__ */ React.forwardRef(function(props, ref) {
  ...
  return /* @__PURE__ */ React.createElement("g", _extends$k({
    className: layerClass
...
var Symbols = function Symbols2(_ref) {
  ...
  if (cx === +cx && cy === +cy && size === +size) {
    return /* @__PURE__ */ React.createElement("path", _extends$j({}, filteredProps, {
...
var DefaultLegendContent = /* @__PURE__ */ (function(_PureComponent) {
  function DefaultLegendContent2() {
    ...
    return _callSuper$a(this, DefaultLegendContent2, arguments);
  }
  _inherits$b(DefaultLegendContent2, _PureComponent);
  return _createClass$e(DefaultLegendContent2, [{
    key: "renderIcon",
    value: (
      /**
    ...
    value: function renderItems() {
      ...
      return payload.map(function(entry, i) {
        ...
        var className = clsx(_defineProperty$y(_defineProperty$y({
        ...
        return /* @__PURE__ */ React.createElement("li", _extends$i({
          className,
          style: itemStyle,
...
var Legend = /* @__PURE__ */ (function(_PureComponent) {
  function Legend2() {
    ...
    _this = _callSuper$9(this, Legend2, [].concat(args));
    _defineProperty$x(_this, "lastBoundingBox", {
      width: -1,
      height: -1
    });
    return _this;
...
var _defineProperty$w;
var hasRequired_defineProperty;
function require_defineProperty() {
  if (hasRequired_defineProperty) return _defineProperty$w;
  ...
  _defineProperty$w = defineProperty;
  return _defineProperty$w;
}
...
function getTooltipCSSClassName(_ref) {
  ...
  return clsx(CSS_CLASS_PREFIX, _defineProperty$u(_defineProperty$u(_defineProperty$u(_defineProperty$u({}, "".concat(CSS_CLASS_PREFIX, "-right"), isNumber(translateX) && coordinate && isNumber(coordinate.x) && translateX >= coordinate.x), "".concat(CSS_CLASS_PREFIX, "-left"), isNumber(translateX) && coordinate && isNumber(coordinate.x) && translateX < coordinate.x), "".concat(CSS_CLASS_PREFIX, "-bottom"), isNumber(translateY) && coordinate && isNumber(coordinate.y) && translateY >= coordinate.y), "".concat(CSS_CLASS_PREFIX, "-top"), isNumber(translateY) && coordinate && isNumber(coordinate.y) && translateY < coordinate.y));
}
...
var TooltipBoundingBox = /* @__PURE__ */ (function(_PureComponent) {
  function TooltipBoundingBox2() {
    var _this;
    _classCallCheck$c(this, TooltipBoundingBox2);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _callSuper$8(this, TooltipBoundingBox2, [].concat(args));
    _defineProperty$t(_this, "state", {
      dismissed: false,
    ...
    _defineProperty$t(_this, "handleKeyDown", function(event) {
      if (event.key === "Escape") {
  ...
  _inherits$9(TooltipBoundingBox2, _PureComponent);
  return _createClass$c(TooltipBoundingBox2, [{
    key: "updateBBox",
    value: function updateBBox() {
      if (this.wrapperNode && this.wrapperNode.getBoundingClientRect) {
        var box = this.wrapperNode.getBoundingClientRect();
...
var Tooltip = /* @__PURE__ */ (function(_PureComponent) {
  function Tooltip2() {
    ...
    return _callSuper$7(this, Tooltip2, arguments);
  }
  _inherits$8(Tooltip2, _PureComponent);
  return _createClass$b(Tooltip2, [{
    key: "render",
    value: function render() {
      var _this = this;
...
var DecimalCSS = /* @__PURE__ */ (function() {
  ...
  return _createClass$a(DecimalCSS2, [{
    key: "add",
...
var _excluded$9 = ["x", "y", "lineHeight", "capHeight", "scaleToFit", "textAnchor", "verticalAnchor", "fill"], _excluded2$2 = ["dx", "dy", "angle", "className", "breakAll"];
function _extends$g() {
...
var Text = function Text2(_ref5) {
  ...
  var dx = props.dx, dy = props.dy, angle = props.angle, className = props.className, breakAll = props.breakAll, textProps = _objectWithoutProperties$9(props, _excluded2$2);
...
var ErrorBar = /* @__PURE__ */ (function(_React$Component) {
  function ErrorBar2() {
    _classCallCheck$9(this, ErrorBar2);
    return _callSuper$6(this, ErrorBar2, arguments);
  }
  _inherits$7(ErrorBar2, _React$Component);
  return _createClass$9(ErrorBar2, [{
    key: "render",
    value: function render() {
      ...
      var errorBars = data.map(function(entry) {
        ...
        return /* @__PURE__ */ React.createElement(Layer, _extends$f({
          ...
          return /* @__PURE__ */ React.createElement("line", _extends$f({}, coordinates, {
...
_defineProperty$p(ErrorBar, "defaultProps", {
  stroke: "black",
  strokeWidth: 1.5,
  width: 5,
  offset: 0,
...
_defineProperty$p(ErrorBar, "displayName", "ErrorBar");
...
var formatAxisMap$1 = function formatAxisMap(props, axisMap, offset, axisType, chartName) {
  ...
  return ids.reduce(function(result, id) {
    ...
    var ticks2 = getTicksOfScale(scale, _objectSpread$l(_objectSpread$l({}, axis), {}, {
      realScaleType
    }));
    var finalAxis = _objectSpread$l(_objectSpread$l(_objectSpread$l({}, axis), ticks2), {}, {
      range: range3,
      radius: outerRadius,
      realScaleType,
      scale,
    ...
    return _objectSpread$l(_objectSpread$l({}, result), {}, _defineProperty$m({}, id, finalAxis));
  }, {});
};
...
var _excluded$6 = ["valueAccessor"], _excluded2$1 = ["data", "dataKey", "clockWise", "id", "textBreakAll"];
...
function LabelList(_ref) {
  ...
  var data = restProps.data, dataKey = restProps.dataKey, clockWise = restProps.clockWise, id = restProps.id, textBreakAll = restProps.textBreakAll, others = _objectWithoutProperties$6(restProps, _excluded2$1);
  if (!data || !data.length) {
    return null;
  }
  return /* @__PURE__ */ React.createElement(Layer, {
...
var Sector = function Sector2(sectorProps) {
  var props = _objectSpread$i(_objectSpread$i({}, defaultProps$2), sectorProps);
...
var Curve = function Curve2(props) {
  ...
  return /* @__PURE__ */ React.createElement("path", _extends$b({}, filterProps(props, false), adaptEventHandlers(props), {
...
function _objectSpread$g(e) {
  for (var r2 = 1; r2 < arguments.length; r2++) {
    var t = null != arguments[r2] ? arguments[r2] : {};
    r2 % 2 ? ownKeys$g(Object(t), true).forEach(function(r22) {
      _defineProperty$h(e, r22, t[r22]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys$g(Object(t)).forEach(function(r22) {
...
var mapObject = function mapObject2(fn, obj) {
  return Object.keys(obj).reduce(function(res, key) {
    return _objectSpread$g(_objectSpread$g({}, res), {}, _defineProperty$h({}, key, fn(key, obj[key])));
  }, {});
};
...
var calStepperVals = function calStepperVals2(easing, preVals, steps) {
  var nextStepVals = mapObject(function(key, val) {
    if (needContinue(val)) {
      ...
      return _objectSpread$f(_objectSpread$f({}, val), {}, {
        from: newX,
        velocity: newV
      });
    }
...
const configUpdate = (function(from, to, easing, duration, render) {
  ...
  var timingStyle = interKeys.reduce(function(res, key) {
    return _objectSpread$f(_objectSpread$f({}, res), {}, _defineProperty$g({}, key, [from[key], to[key]]));
  }, {});
  var stepperStyle = interKeys.reduce(function(res, key) {
    return _objectSpread$f(_objectSpread$f({}, res), {}, _defineProperty$g({}, key, {
      from: from[key],
      velocity: 0,
      to: to[key]
    }));
  ...
  var stepperUpdate = function stepperUpdate2(now) {
    ...
    render(_objectSpread$f(_objectSpread$f(_objectSpread$f({}, from), to), getCurrStyle()));
    preTime = now;
  ...
  var timingUpdate = function timingUpdate2(now) {
    ...
    render(_objectSpread$f(_objectSpread$f(_objectSpread$f({}, from), to), currStyle));
    if (t < 1) {
      cafId = requestAnimationFrame(update);
    } else {
      ...
      render(_objectSpread$f(_objectSpread$f(_objectSpread$f({}, from), to), finalStyle));
    }
  };
...
var Animate = /* @__PURE__ */ (function(_PureComponent) {
  _inherits$6(Animate2, _PureComponent);
  var _super = _createSuper(Animate2);
  function Animate2(props, context) {
    var _this;
    _classCallCheck$8(this, Animate2);
    ...
    _this.handleStyleChange = _this.handleStyleChange.bind(_assertThisInitialized$6(_this));
    _this.changeStyle = _this.changeStyle.bind(_assertThisInitialized$6(_this));
    if (!isActive || duration <= 0) {
      ...
      return _possibleConstructorReturn$6(_this);
    }
    if (steps && steps.length) {
      ...
      _this.state = {
        style: attributeName ? _defineProperty$f({}, attributeName, from) : from
      };
    } else {
      _this.state = {
        style: {}
  ...
  _createClass$8(Animate2, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (!isActive) {
        var newState = {
          style: attributeName ? _defineProperty$f({}, attributeName, to) : to
        };
        if (this.state && style) {
      ...
      this.runAnimation(_objectSpread$e(_objectSpread$e({}, this.props), {}, {
        from,
        begin: 0
      }));
    }
    ...
    value: function runStepAnimation(props) {
      ...
      var addStyle = function addStyle2(sequence, nextItem, index) {
        ...
        var newStyle = _objectSpread$e(_objectSpread$e(_objectSpread$e({}, preItem.style), style), {}, {
          transition
        });
    ...
    value: function runAnimation(props) {
      ...
      var to = attributeName ? _defineProperty$f({}, attributeName, propsTo) : propsTo;
      var transition = getTransitionVal(Object.keys(to), duration, easing);
      manager.start([onAnimationStart2, begin, _objectSpread$e(_objectSpread$e({}, to), {}, {
        transition
    ...
    value: function render() {
      ...
      var cloneContainer = function cloneContainer2(container) {
        ...
        var res = /* @__PURE__ */ reactExports.cloneElement(container, _objectSpread$e(_objectSpread$e({}, others), {}, {
          style: _objectSpread$e(_objectSpread$e({}, style), stateStyle),
          className
        }));
        return res;
      };
...
var Rectangle = function Rectangle2(rectangleProps) {
  var props = _objectSpread$d(_objectSpread$d({}, defaultProps$1), rectangleProps);
  ...
  if (!isUpdateAnimationActive) {
    return /* @__PURE__ */ React.createElement("path", _extends$a({}, filterProps(props, true), {
      className: layerClass,
  ...
  return /* @__PURE__ */ React.createElement(Animate, {
    ...
    }, /* @__PURE__ */ React.createElement("path", _extends$a({}, filterProps(props, true), {
      className: layerClass,
...
var Dot = function Dot2(props) {
  ...
  if (cx === +cx && cy === +cy && r2 === +r2) {
    return /* @__PURE__ */ React.createElement("circle", _extends$9({}, filterProps(props, false), adaptEventHandlers(props), {
      className: layerClass,
      cx,
      cy,
      r: r2
...
var Cross = function Cross2(_ref) {
  var _ref$x = _ref.x, x2 = _ref$x === void 0 ? 0 : _ref$x, _ref$y = _ref.y, y2 = _ref$y === void 0 ? 0 : _ref$y, _ref$top = _ref.top, top = _ref$top === void 0 ? 0 : _ref$top, _ref$left = _ref.left, left = _ref$left === void 0 ? 0 : _ref$left, _ref$width = _ref.width, width = _ref$width === void 0 ? 0 : _ref$width, _ref$height = _ref.height, height = _ref$height === void 0 ? 0 : _ref$height, className = _ref.className, rest = _objectWithoutProperties$4(_ref, _excluded$4);
  ...
  return /* @__PURE__ */ React.createElement("path", _extends$8({}, filterProps(props, true), {
...
var Trapezoid = function Trapezoid2(props) {
  var trapezoidProps = _objectSpread$b(_objectSpread$b({}, defaultProps), props);
  var pathRef = reactExports.useRef();
  ...
  if (!isUpdateAnimationActive) {
    return /* @__PURE__ */ React.createElement("g", null, /* @__PURE__ */ React.createElement("path", _extends$7({}, filterProps(trapezoidProps, true), {
      className: layerClass,
  ...
  return /* @__PURE__ */ React.createElement(Animate, {
    ...
    return /* @__PURE__ */ React.createElement(Animate, {
      ...
      duration: animationDuration,
      easing: animationEasing
    }, /* @__PURE__ */ React.createElement("path", _extends$7({}, filterProps(trapezoidProps, true), {
      className: layerClass,
...
var _excluded$3 = ["option", "shapeType", "propTransformer", "activeClassName", "isActive"];
function _typeof$b(o) {
  "@babel/helpers - typeof";
  return _typeof$b = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(o2) {
    return typeof o2;
...
function Shape(_ref2) {
  var option = _ref2.option, shapeType = _ref2.shapeType, _ref2$propTransformer = _ref2.propTransformer, propTransformer = _ref2$propTransformer === void 0 ? defaultPropTransformer : _ref2$propTransformer, _ref2$activeClassName = _ref2.activeClassName, activeClassName = _ref2$activeClassName === void 0 ? "recharts-active-shape" : _ref2$activeClassName, isActive = _ref2.isActive, props = _objectWithoutProperties$3(_ref2, _excluded$3);
  var shape;
  if (/* @__PURE__ */ reactExports.isValidElement(option)) {
...
var generatePrefixStyle = function generatePrefixStyle2(name, value) {
  ...
  var result = PREFIX_LIST.reduce(function(res, entry) {
    return _objectSpread$9(_objectSpread$9({}, res), {}, _defineProperty$a({}, entry + camelName, value));
  }, {});
  result[name] = value;
  return result;
};
...
var Brush = /* @__PURE__ */ (function(_PureComponent) {
  ...
  return _createClass$7(Brush2, [{
    ...
    value: function renderText() {
      ...
      }, /* @__PURE__ */ React.createElement(Text, _extends$6({
        textAnchor: "end",
        verticalAnchor: "middle",
        x: Math.min(startX, endX) - offset,
        y: y2 + height / 2
      }, attrs), this.getTextOfTick(startIndex)), /* @__PURE__ */ React.createElement(Text, _extends$6({
        textAnchor: "start",
        verticalAnchor: "middle",
...
function typeguardBarRectangleProps(_ref, props) {
  var xProp = _ref.x, yProp = _ref.y, option = _objectWithoutProperties$2(_ref, _excluded$2);
...
var _excluded$1 = ["value", "background"];
var _Bar;
...
var Bar = /* @__PURE__ */ (function(_PureComponent) {
  function Bar2() {
    ...
    _defineProperty$7(_this, "id", uniqueId("recharts-bar-"));
  ...
  return _createClass$6(Bar2, [{
    ...
    value: function renderRectanglesStatically(data) {
      ...
      return data && data.map(function(entry, i) {
        ...
        var props = _objectSpread$6(_objectSpread$6(_objectSpread$6({}, baseProps), entry), {}, {
          isActive,
          option,
          index: i,
          dataKey,
    ...
    value: function renderBackground() {
      ...
      return data.map(function(entry, i) {
        entry.value;
        var background = entry.background, rest = _objectWithoutProperties$1(entry, _excluded$1);
        if (!background) {
          return null;
        }
        var props = _objectSpread$6(_objectSpread$6(_objectSpread$6(_objectSpread$6(_objectSpread$6({}, rest), {}, {
          fill: "#eee"
        ...
        return /* @__PURE__ */ React.createElement(BarRectangle, _extends$4({
...
_Bar = Bar;
_defineProperty$7(Bar, "displayName", "Bar");
_defineProperty$7(Bar, "defaultProps", {
  xAxisId: 0,
  yAxisId: 0,
  legendType: "rect",
  minPointSize: 0,
...
_defineProperty$7(Bar, "getComposedData", function(_ref2) {
  ...
  var itemDefaultProps = item.type.defaultProps;
  var itemProps = itemDefaultProps !== void 0 ? _objectSpread$6(_objectSpread$6({}, itemDefaultProps), item.props) : item.props;
  ...
  var rects = displayedData.map(function(entry, index) {
    ...
    return _objectSpread$6(_objectSpread$6(_objectSpread$6({}, entry), {}, {
      x: x2,
      y: y2,
      width,
      height,
...
var formatAxisMap2 = function formatAxisMap3(props, axisMap, offset, axisType, chartName) {
  ...
  return ids.reduce(function(result, id) {
    ...
    scale.domain(domain).range(range3);
    checkDomainOfScale(scale);
    var ticks2 = getTicksOfScale(scale, _objectSpread$5(_objectSpread$5({}, axis), {}, {
      realScaleType
    }));
    if (axisType === "xAxis") {
    ...
    var finalAxis = _objectSpread$5(_objectSpread$5(_objectSpread$5({}, axis), ticks2), {}, {
      realScaleType,
      x: x2,
      y: y2,
      scale,
    ...
    return _objectSpread$5(_objectSpread$5({}, result), {}, _defineProperty$6({}, id, finalAxis));
  }, {});
};
...
export {
  ...
  mathSign as H,
  max as I,
  polarToCartesian as J,
  require_baseExtremum as K,
  Label as L,
  require_baseGt as M,
  require_baseIteratee as N,
  require_baseLt as O,
  shallowEqual as P,
  uniqueId as Q,
  ReferenceLine as R,
  useArbitraryXAxis as S,
  Text as T,
  useChartHeight as U,
  useChartWidth as V,
  useOffset as W,
  useXAxisOrThrow as X,
  useYAxisOrThrow as Y,
  useYAxisWithFiniteDomainOrRandom as Z,
  warn as _,
  LabelList as a,
  Layer as b,
  Legend as c,
