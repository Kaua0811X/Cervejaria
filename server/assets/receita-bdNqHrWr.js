...
const insumos = [{
  ...
  n: "Malte Chateau Munich",
  q: "75 g"
}, {
  n: "Lúpulo Nugget",
  q: "2,5 g — Amargor"
}, {
  n: "Lúpulo Brewer's Gold",
  q: "2,5 g — Aroma"
}, {
  n: "Fermento Ale",
  q: "1 sachê"
...
const brassagem = [{
  temp: "21°C",
  desc: "Temperatura inicial"
}, {
  temp: "65°C",
  desc: "Mostura — 60 min"
}, {
  temp: "76°C",
  desc: "Mash Out — 15 min"
}, {
  temp: "100°C",
  desc: "Fervura — 60 min"
}];
const fervura = [{
  t: "60 min",
  a: "Adicionar 2,5 g de Lúpulo Nugget (amargor)"
}, {
  t: "10 min finais",
  a: "Adicionar 2,5 g de Lúpulo Brewer's Gold (aroma)"
}, {
  t: "Final",
  a: "Resfriar o mosto abaixo de 35°C rapidamente"
}];
function Receita() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PageShell, { title: "Receita", kicker: "", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 pb-20 space-y-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-strong rounded-3xl p-6 md:p-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap items-end justify-between gap-4 mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] uppercase tracking-[0.4em] text-gold", children: "Receita ativa · 5 L" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl md:text-5xl text-gradient-gold mt-2", children: recipe.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-[color:var(--muted-foreground)] mt-2 max-w-xl", children: "Cerveja dourada, leve e refrescante. Processo rápido, ideal para iniciantes — perfil pilsen com fermentação Ale para simplificar o domínio doméstico." })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 lg:grid-cols-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-4", children: [{
          l: "ABV",
          v: recipe.abv
        }, {
          l: "IBU",
          ...
          l: "FG",
          v: recipe.fg
        }].map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-xl p-4 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-[color:var(--muted-foreground)] uppercase tracking-[0.3em]", children: m.l }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-2xl text-gradient-gold mt-1", children: m.v })
        ] }, m.l)) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-xl p-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-[color:var(--muted-foreground)] uppercase tracking-widest mb-2", children: "Perfil sensorial" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[320px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(RadarChart, { data: radarData, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(PolarGrid, { stroke: "oklch(0.78 0.14 85 / 0.25)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(PolarAngleAxis, { dataKey: "k", tick: {
              fill: "oklch(0.78 0.14 85)",
              fontSize: 12
            } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(PolarRadiusAxis, { tick: {
              fill: "oklch(0.72 0.04 85)",
              fontSize: 10
            }, stroke: "oklch(0.78 0.14 85 / 0.3)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Radar, { name: "Perfil", dataKey: "v", stroke: "oklch(0.88 0.16 90)", fill: "oklch(0.78 0.14 85)", fillOpacity: 0.5 })
          ] }) }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-[color:var(--muted-foreground)] uppercase tracking-widest mb-3", children: "Insumos selecionados" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3 md:grid-cols-3 lg:grid-cols-6", children: insumos.map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-lg p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gold font-display text-sm", children: i.n }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-[color:var(--muted-foreground)] mt-1", children: i.q })
        ] }, i.n)) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-strong rounded-3xl p-6 md:p-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] uppercase tracking-[0.4em] text-gold", children: "Processo" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl md:text-3xl text-gradient-gold mt-1 mb-8", children: "Fabricação passo a passo" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 lg:grid-cols-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-2xl p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gold font-display text-xl mb-3", children: "I · Mostura" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 text-sm text-[color:var(--muted-foreground)]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold-soft", children: "Aquecimento:" }),
              " 3 L de água a 70°C antes dos grãos."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold-soft", children: "Repouso:" }),
              " 65°C por 60 min — conversão do amido."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold-soft", children: "Mash Out:" }),
              " 76°C por 15 min para parar as enzimas."
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-2xl p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gold font-display text-xl mb-3", children: "II · Clarificação & Sparge" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 text-sm text-[color:var(--muted-foreground)]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Recircular o mosto até ficar límpido." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Lavar os grãos com 4 L de água a 76°C." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Volume inicial de fervura: aprox. 8 L." })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-2xl p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gold font-display text-xl mb-3", children: "III · Fervura · 60 min" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3 text-sm text-[color:var(--muted-foreground)]", children: fervura.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-gold-soft", children: [
              f.t,
              ":"
            ] }),
            " ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-strong rounded-3xl p-6 md:p-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] uppercase tracking-[0.4em] text-gold", children: "Brassagem" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl md:text-3xl text-gradient-gold mt-1 mb-8", children: "Curva térmica · Session Pilsen SQN" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-0 right-0 top-1/2 h-px bg-gradient-to-r from-transparent via-[color:var(--gold)]/50 to-transparent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 relative", children: brassagem.map((b, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-xl p-5 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] uppercase tracking-[0.3em] text-[color:var(--muted-foreground)]", children: [
            "Passo ",
            i + 1
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-3xl text-gradient-gold mt-2", children: b.temp }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-gold-soft mt-2", children: b.desc })
        ] }, b.temp)) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-strong rounded-3xl p-6 md:p-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] uppercase tracking-[0.4em] text-gold", children: "Etapa IV" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl text-gradient-gold mt-1 mb-5", children: "Fermentação & Maturação" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-4 text-sm text-[color:var(--muted-foreground)]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "glass rounded-xl p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gold font-display", children: "Fermentação · ~10 dias" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1", children: "Manter a 18°C. Próximo ao fim, subir para 20°C por 4 dias para o descanso de diacetil." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "glass rounded-xl p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gold font-display", children: "Maturação · mín. 7 dias" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1", children: "Baixar para 10°C por alguns dias, depois aproximar-se de 0°C por pelo menos 7 dias para clarificação." })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-strong rounded-3xl p-6 md:p-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] uppercase tracking-[0.4em] text-gold", children: "Etapa V" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl text-gradient-gold mt-1 mb-5", children: "Envase & Priming" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-4 text-sm text-[color:var(--muted-foreground)]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "glass rounded-xl p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gold font-display", children: "Priming" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1", children: "6,5 g de açúcar por litro, diluído em água estéril." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "glass rounded-xl p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gold font-display", children: "Carbonatação" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1", children: "Garrafas em temperatura ambiente (18–25°C) por 10 dias para gerar gás natural." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "glass rounded-xl p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gold font-display", children: "Consumo" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1", children: "Melhor apreciada jovem — frescor é coroação." })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-[10px] uppercase tracking-[0.4em] text-[color:var(--muted-foreground)]", children: "Receita adaptada · Faz Tua Ceva ⚜ Rei do Malte" })
  ] }) });
}
export {
  Receita as component
};
