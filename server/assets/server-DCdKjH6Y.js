...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BSAwMgGU.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DSrW3ttm.js").then((n2) => n2.r),
    import("./start-fAZNrSlp.js"),
...
var ROUTER_BASEPATH = "Cervejaria";
var SERVER_FN_BASE = "/Cervejaria/_serverFn/";
...
export {
  ...
  cleanPath as d,
  commonjsGlobal as e,
  compileDecodeCharMap as f,
  composeRewrites as g,
  createControlledPromise as h,
  createLRUCache as i,
  createMiddleware as j,
  decodePath as k,
  deepEqual as l,
